...
def userdesignsbanner(request):
    userdesignsbanners = Product.objects.filter(category='UDB', status=True)
...
def userdesignsintro(request):
    userdesignsintros = Product.objects.filter(category='UDI', status=True)
...
def userdesignsoutro(request):
    userdesignsoutros = Product.objects.filter(category='UDO', status=True)
...
def userdesignsposters(request):
    userdesignsposters = Product.objects.filter(category='UDP', status=True)
...
def userdesignsothers(request):
    userdesignsothers = Product.objects.filter(category='UDOth', status=True)
